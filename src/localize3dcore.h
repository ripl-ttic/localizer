...
#include <carmen_utils/carmen.h>//map.h>
...
#define      MAX_BEAMS_PER_SCAN   2048
    ...
    typedef struct {
        ...
        carmen3d_localize_motion_model_t *motion_model;
#endif
    } carmen3d_localize_param_t, *carmen3d_localize_param_p;

    typedef struct {
        float x, y, theta, weight;
    } carmen3d_localize_particle_t, *carmen3d_localize_particle_p;

    typedef struct {
        int initialized, first_odometry, global_mode;
        carmen3d_localize_param_p param;
        carmen3d_localize_particle_p particles;
        carmen_point_t last_odometry_position;
        float **temp_weights;
        float distance_travelled;
        float heading_turned;
        char laser_mask[MAX_BEAMS_PER_SCAN];
    } carmen3d_localize_particle_filter_t, *carmen3d_localize_particle_filter_p;

    typedef struct {
        float x, y, range;
        float prob;
        char mask;
    } carmen3d_localize_laser_point_t, *carmen3d_localize_laser_point_p;
    ...
    typedef struct {
        ...
        int converged;
        int num_readings;
        carmen3d_localize_laser_point_t mean_scan[MAX_BEAMS_PER_SCAN];
    } carmen3d_localize_summary_t, *carmen3d_localize_summary_p;

#include "likelihood3d_map.h"


    /** Create (allocate memory for) a new particle filter **/
    carmen3d_localize_particle_filter_p
    carmen3d_localize_particle_filter_new(carmen3d_localize_param_p param);
     ...
     **/
    void
    carmen3d_localize_initialize_particles_uniform(carmen3d_localize_particle_filter_p filter,
                                                   carmen_robot_laser_message *laser,
                                                   carmen3d_localize_map_p map);
     ...
     **/
    void
    carmen3d_localize_initialize_particles_gaussians(carmen3d_localize_particle_filter_p filter,
                                                     int num_modes,
                                                     carmen_point_t *mean,
                                                     carmen_point_t *std);
     ...
     **/
    void
    carmen3d_localize_initialize_particles_gaussian(carmen3d_localize_particle_filter_p filter,
                                                    carmen_point_t mean,
                                                    carmen_point_t std);
     ...
     **/
    void
    carmen3d_localize_initialize_particles_manual(carmen3d_localize_particle_filter_p filter,
                                                  double *x,
                                                  double *y,
                                                  double *theta,
                                                  double *weight,
    ...
    int
    carmen3d_localize_initialize_particles_placename(carmen3d_localize_particle_filter_p filter,
     ...
     **/
    void
    carmen3d_localize_incorporate_odometry(carmen3d_localize_particle_filter_p filter,
     ...
     **/
    void
    carmen3d_localize_incorporate_laser(carmen3d_localize_particle_filter_p filter,
                                        carmen3d_localize_map_p map,
                                        int num_readings,
                                        float *range,
     ...
     **/
    void
    carmen3d_localize_resample(carmen3d_localize_particle_filter_p filter);
     ...
     **/
    void
    carmen3d_localize_run(carmen3d_localize_particle_filter_p filter,
                          carmen3d_localize_map_p map,
                          carmen_robot_laser_message *laser,
                          double forward_offset,
                          int backwards);
    ...
    void
    carmen3d_localize_laser_scan_gd(int num_readings,
                                    float *range,
                                    double angular_resolution,
                                    double first_beam_angle,
    ...
    void
    carmen3d_localize_summarize(carmen3d_localize_particle_filter_p filter,
