...
static void create3d_distance_map(carmen_map_p cmap, carmen3d_localize_map_p lmap,
...
void create_likelihood_map(carmen3d_localize_map_p lmap, 
...
void create_stretched_likelihood_map(carmen3d_localize_map_p lmap, 
...
void carmen3d_to_localize_map(carmen_map_p cmap, carmen3d_localize_map_p lmap,
			    carmen3d_localize_param_p param)
{
  int i;
  ...
  create3d_distance_map(cmap, lmap, param);
...
void carmen3d_localize_write_map_to_ppm(char *filename, 
...
void carmen3d_localize_write_distance_map_to_ppm(char *filename, 
					       carmen3d_localize_map_p map)
{
  FILE *fp;
  int i, j;
...
void carmen3d_localize_write_likelihood_map_to_ppm(char *filename, 
						 carmen3d_localize_map_p map,
						 float **prob)
{
  FILE *fp;
